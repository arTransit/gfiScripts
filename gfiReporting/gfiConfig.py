...
def chilliwackRoute11SQL(year,month):
    ...
    return (
        ...
        "from ( "
            ...
            "where "
                "ml.loc_n in ( %s ) "
                "and ml.ts between to_date('%s-%s-01', 'YYYY-MM-DD') and last_day(to_date('%s-%s-01', 'YYYY-MM-DD'))+1 "
                "and ml.bus in (%s) "
                "and ev.route <> %s "
...
def exceptionReportSQL(location,year,month):
    ...
    return (
        ...
        "from ( "
            ...
            "where   "
                "ml.loc_n in ( %s ) and  "
                "ml.ts between (to_date('%s-%s-01', 'YYYY-MM-DD') -7) and last_day(to_date('%s-%s-01', 'YYYY-MM-DD'))+1 and  "
            ...
            "where  "
                ...
                "ml.ts between (to_date('%s-%s-01', 'YYYY-MM-DD') -7) and "
                        "last_day(to_date('%s-%s-01', 'YYYY-MM-DD'))+1 and  "
                "ev.drv not in ( "
                    "select drv "
...
def msreportSQL(location,year,month):
    ...
    return (
        ...
        "from ( "
            ...
            "from all_objects "
            "where rownum <= last_day(to_date('%s-%s-01','YYYY-MM-DD')) +1 - to_date('%s-%s-01','YYYY-MM-DD') "
        ") dates "
        "left join ( "
